// #include <bits/stdc++.h>
#include<iostream>
#include<cstring>//Hash including all the necessary header files
using namespace std;

//Defining a class named Event which has attributes date ,begin,end and the event name of the event
class Event
{
    // THe class attributes are set tpo privtae to make them inaccessible outside the class
    private:
    int date;//The date of the event
    int begin;//The begin of the event
    int end;//The end of the
    char eventname[100];//The event name
