...
{
    int mammal_count = 0, reptile_count = 0, bird_count = 0, aquatic_count = 0;
...
void save_database(string filename)
{
    ...
    outfile << "mammal " << mammal_count << endl;
    // Save all mammals
    for (auto s : species_db)
    {
        if (s->isMammal())
    ...
    outfile << "reptile " << reptile_count << endl;
    // Save all reptiles
    for (auto s : species_db)
    {
        if (s->isReptile())
    ...
    outfile << "aquatic " << aquatic_count << endl;
